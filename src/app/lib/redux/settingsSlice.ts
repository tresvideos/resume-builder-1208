...
export const settingsSlice = createSlice({
  ...
  reducers: {
    setSelectedTemplate: (draft, action: PayloadAction<Settings['selectedTemplate']>) => { draft.selectedTemplate = action.payload; },
    changeSettings: (
      draft,
...
export const selectSelectedTemplate = (state: RootState) => state.settings.selectedTemplate;
